...
This is a sample template for tapi - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name tapi --tail
```
...
```bash
aws cloudformation delete-stack --stack-name tapi
```
